...
\end{Sinput}
\begin{Soutput}
R version 2.14.0 beta (2011-10-16 r57266)
...
[1] drosgenome1.db_2.6.3  org.Dm.eg.db_2.6.3   
[3] RSQLite_0.10.0        DBI_0.2-5            
[5] annotate_1.31.1       AnnotationDbi_1.15.38
[7] tigre_1.7.4           Biobase_2.13.11      

loaded via a namespace (and not attached):
 [1] affy_1.31.6           affyio_1.21.2        
 [3] BiocInstaller_1.1.28  gdata_2.8.2          
 [5] gplots_2.10.1         gtools_2.6.2         
 [7] IRanges_1.11.31       preprocessCore_1.15.0
 [9] puma_2.5.0            tools_2.14.0         
[11] xtable_1.6-0          zlibbioc_0.1.8       
\end{Soutput}
\end{Schunk}
